...
const protocols: Protocol[] = [
  ...
  },
  {
    ...
    "defillama": {
      "slug": "corn-kernels",
      "description": "Kernels are off-chain points that represent your share of the initial $CORN Community Airdrop",
  ...
  },
  {
    ...
    "symbol": "ETHFI",
    "listedAt": 1741711269,
    "referralUrl": "https://app.ether.fi/weeth?address=0xd3be243c7b11cc0233af0caebac54b713d1403b1",
  ...
  },
  {
    ...
    "symbol": "GFI",
    "listedAt": 1741711269,
    "referralUrl": "https://gravityfinance.io/silov2?referrer=0xD3bE243C7B11Cc0233af0cAeBAc54b713d1403b1",
  ...
  },
  {
    ...
    "name": "KelpDAO",
    "listedAt": 1741711269,
    "referralUrl": "https://kelpdao.xyz/restake/?utm_source=0xD3bE243C7B11Cc0233af0cAeBAc54b713d1403b1",
    "portfolioUrl": "https://kelpdao.xyz/defi",
    "claimUrl": "https://kerneldao.com/claim-airdrop/",
    "module": "adapters/kelpdao.ts",
    "defillama": {
      "slug": "kelp",
      "description": "Kelp is the second largest liquid restaking protocol with ~$2B+ in TVL. Its liquid restaked token, rsETH, is live across 10+ major L2s and 40+ DeFi platforms, allowing users to restake while maintaining full liquidity.",
  ...
  },
  {
    ...
    "defillama": {
      "slug": "superform",
      "description": "Superform is the onchain wealth app. Superform earns you the best returns on your crypto to grow your onchain wealth. Use SuperVaults to automatically optimize your earnings, or build your customized portfolio by directly depositing into over 800 earning opportunities",
  ...
  },
  {
    ...
    "defillama": {
      "slug": "",
      "description": "Automate your swapping, staking, and minting actions across 150+ of your favorite dApps & enjoy a seamless UX",
  ...
  },
  {
    ...
    "defillama": {
      "slug": "swapx-v2",
      "description": "SwapX, Sonic's native DEX, leverages Algebra V4 for advanced concentrated liquidity management and ve(3,3) tokenomics while pioneering modular DeFi with plugin technology",
  ...
  },
  {
    ...
    "referralUrl": "https://app.rings.money/#/points?referrer=0xD3bE243C7B11Cc0233af0cAeBAc54b713d1403b1",
  ...
  },
  {
    ...
    "defillama": {
      "slug": "level",
      "description": "Level is a yield-bearing stablecoin protocol powered by USDT and USDC deposited into DeFi-native sources.",
  ...
  },
  {
    ...
    "defillama": {
      ...
      "description": "Infrared is a decentralized protocol that allows users to earn yield on their assets by staking them in a decentralized manner.",
  ...
  },
  {
    ...
    "defillama": {
      "slug": "ethena-usde",
      "description": "Ethena is a decentralized protocol that allows users to earn yield on their assets by staking them in a decentralized manner.",
  ...
  },
  {
    ...
    "defillama": {
      "slug": "sparklend",
      "description": "Spark is an at-scale stablecoin allocation engine capturing yield across DeFi, RWAs and exchanges. This yield is provided cross-chain to Savings USDS holders",
